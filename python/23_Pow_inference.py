...
session = ort.InferenceSession("23_pow.onnx")
input_data1 = np.abs(np.random.randn(1, 3, 32, 32)).astype(np.float32)
...
print("Pow演算が正常に実行されました")
print(f"入力1の一部: {input_data1[0, 0, 0, :3]}")
print(f"入力2の一部（指数）: {input_data2[0, 0, 0, :3]}")
